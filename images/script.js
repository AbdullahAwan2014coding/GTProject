...
var audio = audio.getElementById("PA");



// Set the volume (between 0 and 1)

audio.volume = 0.1;  // Example: set volume to 50%



// To change volume dynamically based on user interaction (e.g., with a custom volume slider):

//  - Get the new volume value from the slider

//  - Update the audio.volume property accordingly 
